...
The process of feature engineering did however prove to be rather time consuming, and the usefulness of the resulting features was difficult to reason about, as we do not possess the required domain knowledge. As such we are unsure whether we can develop features of sufficient quality within the allotted project time. Due to this we examined an alternative approach, feature learning, to generate this feature representation.
...
However, an increased level of automation makes it more difficult to understand an outcome in \todo{result of?} the machine learning process. As such the features generated by feature learning are suited for reasoning by machine intelligence algorithms, and are difficult for humans to interpret. In practice this has been shown to be of minor concern, as many applications have experienced greatly improved performance using feature learning~\cite{bengio2013representation}.
