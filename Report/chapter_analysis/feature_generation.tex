...
The process of feature engineering did however prove to be rather time consuming, and the usefulness of the resulting features was difficult to reason about, due to insufficient domain knowledge. Due to this we examined alternative approaches to generate this feature representation, namely feature learning.

\todo{Det er et tyndt afsnit, tyndt grundlag. Udvid med forklaring af anerkendte teknikker/metoder. Find kilder der snakker om hvordan man laver feature engineering, og snak om hvilke teknikker de bruger. Hvis ``teknikken'' er ``viden indenfor området'', så skriv det.}
...
\todo{Synes stadig ikke vi skal nævne hyperparameters her, vi kan godt slette det og stadig komme med den næste pointe}
