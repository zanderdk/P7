...
As described in \todo{link til sted, eller flyt det sted til her}, test data consists of 20\% of all data samples. \todo{tyndt, skal stå sammen med begrundelsen for de 20\% etc}
