\begin{tikzpicture}[node distance = 2.84cm, auto]
    ...
    \node [bigblock, right of=db] (ap) {Candidate Filtering};
    ...
    \node [smallblock, below=1.5cm of ap, xshift=-2em] (n2v) {Model Trainer};
    ...
    \path [line] (n2v.east) -| node [near end, align=right] {Feature\\Model} ([xshift=-1.2em]tfl.south);
    ...
    \path [line] (classifierTrainer) -- node[align=right]{Classification\\Model} (classifier);
