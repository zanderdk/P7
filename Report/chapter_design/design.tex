...
\todo{Is the reasoning for filtering and refinement adequate? consider especially the final sentence}\todo{Michael synes hele den sidste sætning ikke er nødvendig. Det store tal i sig selv burde være nok argumentation.}
