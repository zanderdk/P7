...
As seen in \cref{tab:db_labels_edges}, the links are split into three groups, \mono{LinksTo}, \mono{TrainingData}, and \mono{TestData}. \mono{TrainingData} and \mono{TestData} are disjoint links from featured articles that later will be used to train and evaluate the classifer. The splits are made randomly, according to a partitioning given in \cref{sec:classifier}.
