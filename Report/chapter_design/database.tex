...
We currently store about 11 million articles of which only about 5 million are relevant. The remaining articles are automatically generated pages with little or no content. We chose to store them as well to avoid further processing of the data. \todo{review: Comment on why we have 11 million articles instead of 5 million.}
