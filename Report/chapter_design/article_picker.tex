...
Preliminary results with this approach have been promising. A downside for this approach is that it only produces a limited amount of candidate pairs \todo{roughly how many?}. Therefore, we choose to complement it with another approach to get a bigger set of candidate pairs.
