...
\begin{itemize}
  ...
  \item How to distinguish between these two classes?
  \item What is a reasonable method of presenting these to a user?
  \item How can the solution be scaled, such that it works (on a reasonable computer, on all of Wikipedia (English), quickly for the users)?
\end{itemize}
