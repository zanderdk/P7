...
\note{
	\begin{itemize}
    \item In the large, dev. method \textbf{adequate}
			\begin{itemize}
				\item \textbf{In part due} to experimental nature
				\item and because \textbf{less emphasis} on ``lots of code''
...
\note{
    ...
    \item Manageable projects
		\begin{itemize}
			...
			\item Again: However, learned a lot
		\end{itemize}
...
\note{
	\begin{itemize}
    \item Overall, we designed and impl. software solution to \textbf{suggest} article links. Predictions made on structural info.
