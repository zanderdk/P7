...
\note{
	\begin{itemize}
		\item We \textbf{argue}... benefit from \textbf{experimental approach}
		\begin{itemize}
			\item dismiss anal. heavy
		\end{itemize}
...
\note{
    ...
    \item In the large, \textbf{adequate method}
			\begin{itemize}
				...
				\item \textbf{less emphasis} on ``lots of code''
			...
			\end{itemize}
			\item In hindsight,\textbf{ status meetings} benefited \textbf{timeboxed}
...
\note{
    ...
    \item We initially \textbf{spent long time on identifying project}
		\begin{itemize}
			...
			\item We chose project with \textbf{large span} in terms of work + poss.
		\end{itemize}
		...
		\begin{itemize}
			\item therefore \textbf{feat. lear. approach} based on structure good
...
\note{
    ...
    \item Manageable projects
		...
		\begin{itemize}
			\item Careful about details and... \textbf{in isolation}
		\end{itemize}
		\item Combination of working with lots of data + timeb. proj. period.
		\begin{itemize}
...
\note{
    ...
    \item Overall, we designed and impl. software solution to suggest article links. Predictions made on structural info.
		...
		\begin{itemize}
			...
			\item \textbf{further refinement} may make adequate solution
		\end{itemize}
